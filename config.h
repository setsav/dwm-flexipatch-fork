...
static const char *downbrightness[]   = { "sh", ".dwm/master.sh", "brightdec", NULL };
...
static char titlenormfgcolor[]           = "#808080";
...
static const char *discord[]  = { "discord", "--start-minimized", NULL };
...
/*	{ MODKEY|Mod4Mask,              XK_i,          incrigaps,              {.i = +1 } },
	...
	{ MODKEY,                       XK_q,          viewtoleft,             {0} }, // note keybinding conflict with focusdir
	{ MODKEY,                       XK_w,          viewtoright,            {0} }, // note keybinding conflict with focusdir
	{ MODKEY|ShiftMask,             XK_q,          tagtoleft,              {0} },
	{ MODKEY|ShiftMask,             XK_w,          tagtoright,             {0} },
	{ MODKEY|ControlMask,           XK_q,          tagandviewtoleft,       {0} },
	{ MODKEY|ControlMask,           XK_w,          tagandviewtoright,      {0} },
	...
	{ MODKEY|ShiftMask,             XK_b,      spawn,          {.v = browser} },	
        ...
        { MODKEY|ShiftMask,             XK_n,      spawn,          {.v = vinote } },	
        { MODKEY|ShiftMask,             XK_f,      spawn,          {.v = fileman } },	
        { MODKEY,                       XK_v,      spawn,          {.v = volmix } },	
        { MODKEY|ShiftMask|ControlMask, XK_f,      spawn,          {.v = fileman2 } },	
        { MODKEY,                       XK_o,      spawn,          {.v = powermenu } },	
        { MODKEY,                       XK_b,      spawn,          {.v = bluetmenu } },	
